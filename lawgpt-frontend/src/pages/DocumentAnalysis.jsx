  ...
  return (
    <div className="document-analysis-container">
      ...
      <div className="document-analysis-header">
        <h1>Document <span className="text-accent">Analysis</span></h1>
                  ...
                  {isUploading ? (
                    <>
                      <div className="button-loader">
                        <FaviconLoader color="#ffffff" size="sm" />
                      </div>
      ...
      <div className="document-analysis-footer">
        <p>
          <i className="bi bi-shield-lock"></i> 
          Documents are securely processed and not stored beyond analysis requirements.
        </p>
      </div>
    </div>
  );
